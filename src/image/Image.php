...
use filemanager\image\Image_Driver;

use filemanager\image\drivers\Image_GD_Driver;

//require 'drivers/Image_GD_Driver.php';
//require 'drivers/Image_ImageMagick_Driver.php';

use filemanager\image\drivers\Image_ImageMagick_Driver;
/**
...
class Image
{
    ...
    public function __construct($image, $config = NULL)
    {
        ...
        $driver = 'filemanager\\image\\drivers\\Image_' . ucfirst($this->config['driver']) . '_Driver';
