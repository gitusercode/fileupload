<?php
namespace filemanager\image\drivers;

use filemanager\image\Image_Driver;
use filemanager\image\Image;
/**
 * GD Image Driver.
 *
...
class Image_GD_Driver extends Image_Driver
{
    ...
    public function __construct()
    {
        ...
        if (!function_exists('gd_info'))
            throw new \Exception('Image component requires GD');
        ...
        if (strpos($info['GD Version'], '2.') === FALSE)
            throw new \Exception('Image component requires GD v2');
    }
